...
def show_confirmation(title: str, message: str, parent=None, 
                     on_confirm: Callable = None, on_cancel: Callable = None) -> bool:
...
def show_input_dialog(title: str, message: str, default_value: str = "", 
                     parent=None, on_ok: Callable = None, on_cancel: Callable = None) -> Optional[str]:
