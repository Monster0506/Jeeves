...
class ChatManager:
    ...
    def create_thread(self, name: str, icon: str = "💬", description: str = None,
                     tags: List[str] = None, metadata: Dict = None, settings: Dict = None) -> int:
        """
    ...
    def get_threads(self, active_only: bool = True, include_archived: bool = False,
    ...
    def add_user_message(self, content: str, content_type: str = 'text',
                        metadata: Dict = None, attachments: List[Dict] = None) -> int:
        """
    ...
    def add_ai_message(self, content: str, content_type: str = 'text',
                      metadata: Dict = None, attachments: List[Dict] = None) -> int:
        """
    ...
    def add_system_message(self, content: str, content_type: str = 'text',
    ...
    def search_messages(self, query: str, thread_id: int = None, limit: int = 50,
    ...
    def get_conversation_summary(self, thread_id: int = None) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'other_messages': sum(count for sender, count in sender_counts.items() 
    ...
    def set_user_setting(self, key: str, value: Any, value_type: str = 'string',
