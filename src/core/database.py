...
class DatabaseManager:
    ...
    def create_thread(self, name: str, icon: str = None, description: str = None, 
    ...
    def add_message(self, thread_id: int, sender: str, content: str, 
                   content_type: str = 'text', metadata: Dict = None, 
                   attachments: List[Dict] = None, parent_message_id: int = None,
                   reply_to_message_id: int = None) -> int:
        """
        ...
        def _add():
            with self._get_connection() as conn:
                ...
                """, (
                    thread_id, sender, content, content_type,
                    json.dumps(metadata) if metadata else None,
    ...
    def get_messages(self, thread_id: int, limit: int = None, offset: int = 0,
